...
?>
    ...
    <body>
        ...
        <form method="POST" >
            ...
            <a href="cadastrar.php">Ainda não tem cadastro para votar?<strong>Cadastre-se já e borá ser eleitor!</strong></a>
        </form>
        </div>
        <?php
        if(isset($_POST['email'])){
            ...
            if(!empty($email) && !empty($senha)){
                $u->conectar("bdaw2","localhost","root","");
                if($u->msg == ""){
                    if($u->logar($email, $senha)){
                        header("location: area_eleitoral.php");
                    }else{
